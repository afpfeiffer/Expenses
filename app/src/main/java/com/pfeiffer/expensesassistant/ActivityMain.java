...
public class ActivityMain extends Activity {
	...
	ExpandableListView expandableListView_;
	ArrayList<HashMap<String, String>> mylist_title;
	ArrayList<ArrayList<HashMap<String, String>>> mylist;
	...
	private void showActivity() {
		...
		if( ! values.isEmpty() ) {
			...
			// TODO set list view group for month
			ArrayList<HashMap<String, String>> secList = new ArrayList<HashMap<String, String>>();

			// TODO loop through expenses for month and create child
			for( Purchase purchase : values ) {
				...
				Log.d( this.getClass().getName(), "Purchase " + purchase + " has monthYear=" + monthYear );
				...
				map2.put( "rowTotalPrice", purchase.getTotalPrice() + " Û" );
				secList.add( map2 );
			...
			map1.put( "rowMonthName", Translation.getMonthString( currentMonthYear.substring( 5, 7 ) ) + " "
					+ currentMonthYear.substring( 0, 4 ) );
			map1.put( "rowMonthExpenses", Translation.getValidPrice( String.valueOf( sumTotalMonthExpenses ) ) + " Û" );
			mylist_title.add( map1 );
	...
	public void onCreateContextMenu( ContextMenu menu, View v, ContextMenuInfo menuInfo ) {
		...
		if( type == ExpandableListView.PACKED_POSITION_TYPE_CHILD ) {
			...
			menu.add( 0, 1, 0, "Lšschen" );
			Log.d( this.getClass().getName(), "ContextMenu created for item with id "
	...
	private boolean deletePurchase( int groupPos, int childPos ) {
		...
		mylist_title.get( groupPos ).put(
				"rowMonthExpenses",
				Translation.getValidPrice( String.valueOf( sumTotalMonthExpenses ) ) + " Û" );
	...
	public void recordPurchase( View view ) {
		Intent intent = new Intent( this, ActivityEnterName.class );
		startActivity( intent );
	}
