...
import com.pfeiffer.expensesassistant.ExpensesSQLiteHelper.QueryBuilder;

public class RepositoryProduct extends RepositoryBase {

	private String[] allProductColumns_ = { ExpensesSQLiteHelper.PRODUCT_ID, ExpensesSQLiteHelper.PRODUCT_NAME,
	...
	Product findProduct( int id, String name, String price, String barcode ) {
		...
		Log.d( this.getClass().getName(), "Where clause: " + whereString + " with arguments: " + whereArgs.toString() );
