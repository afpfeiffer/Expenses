...
public class RepositoryPurchase extends RepositoryBase {
	private String[] allPurchaseColumns_ = { ExpensesSQLiteHelper.PURCHASE_ID,
	...
	protected boolean updatePurchase( int purchaseId, String price, int amount, LOCATION location ) {
	...
	private Purchase cursorToPurchase( Cursor cursor ) {
		...
		Purchase ret = new Purchase( cursor.getInt( 0 ), cursor.getInt( 1 ), cursor.getInt( 2 ), cursor.getString( 3 ),
